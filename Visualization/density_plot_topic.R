...
density_plot_topic <- function(file_string){
 ...
 argument_frame = data.frame( match = c("economy", "religion", "politics", "tourism", "overall"),
                  files = c("~/work/Glob_Analytics/Visualization/csv/geo_economy.csv", "~/work/Glob_Analytics/Visualization/csv/geo_religion.csv", "~/work/Glob_Analytics/Visualization/csv/geo_politic.csv", "~/work/Glob_Analytics/Visualization/csv/geo_tourism.csv", "~/work/Glob_Analytics/Visualization/csv/world_tweets.csv")
 )
