...
plot_per_tweets <- function(file_string){
  ...
  argument_frame = data.frame( match = c("economy", "religion", "politics", "tourism", "overall"),
                               files = c("economy_tweets.csv", "religion_tweets.csv", "politic_tweets.csv", "tourism_tweets.csv", "overall_plots")
  )
  ...
  if(file_string == "overall"){
    eco <- read.csv(file="economy_tweets.csv",head=TRUE,sep=",")
    rel <- read.csv(file="religion_tweets.csv",head=TRUE,sep=",")
    pol <- read.csv(file="politic_tweets.csv",head=TRUE,sep=",")
    tour <- read.csv(file="tourism_tweets.csv",head=TRUE,sep=",")
